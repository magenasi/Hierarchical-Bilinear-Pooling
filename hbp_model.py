...
class Net(nn.Module):
    def __init__(self):
        ...
        # fc layer
        self.fc_concat = torch.nn.Linear(8192 * 3, 6)
        ...
        #                                       model_root='pre-weights/resnet34-pre.pth')

        self.features = resnet_model.resnet50(pretrained=True,
                                              model_root='pre-weights/resnet50-pre.pth')
    ...
    def forward(self, x):
        ...
        # inter1.shape = torch.Size([1, 8192, 7, 7])
        # inter2.shape = torch.Size([1, 8192, 7, 7])
        # inter3.shape = torch.Size([1, 8192, 7, 7])
